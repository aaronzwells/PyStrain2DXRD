...
# --- new plotting using EllipseModel ---

def plot_ellipse_fits(chi, q_vs_chi, output_path=None, dpi=600):
    """
    Plot raw q_vs_chi data and overlay an ellipse fit in radial coordinates for each ring.
    """
    ...
    for j, ax in enumerate(axes):
        ...
        # generate ellipse in parametric form
...
def main():
    ...
    # detect and fit peaks to get q_peaks and windows
