...
def integrate_2d(ai, data, mask, num_azim_bins=360, q_min=16.0, npt_rad=5000):
    ...
    """
    # get full radial axis to determine q_max
...
def _fit_slice(int_row, q_peaks, peak_windows, widths_q, q, delta_tol=0.05, eta0=0.5):
    """Helper: fit all rings in a single azimuthal slice intensity row."""
    out = []
...
# --- Plot Pseudo-Voigt centroids with Fourier overlay -------------------
...
def main():
    ...
    delta_tol      = 0.05
    eta0           = 0.5
    harmonics      = (1,2) #fitting harmonics for Fourier fitting function
    output_png     = f"OutputFiles/Fits/SSAO_fourier_{num_azim_bins}bin_r1.png"
    ...
    q_vs_chi       = fit_slices_parallel(I2d, q_peaks, pw, wq, q,
                                         delta_tol=delta_tol, eta0=eta0)
    plot_fitted_q_vs_chi(chi, q_vs_chi, delta_tol,
                         harmonics,
